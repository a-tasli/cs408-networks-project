...
q_amount_entry = ttk.Entry(frm).grid(column=1, row=3)
path_entry = ttk.Entry(frm).grid(column=1, row=5)

ttk.Button(frm, text="Quit", command=root.destroy).grid(column=1, row=7, columnspan=2)
root.mainloop()
# port number entry
# no of qs
# question filename
